...
int main()
{
	...
	
	{
		...
		auto joPool = jcClassPool.Do<&jcClassPool>("getDefault");
		...
		JClass jcCtClass("javassist.CtClass");
		auto joCModInitializer = joPool.Do<&jcCtClass>("get", JString("net.fabricmc.api.ModInitializer"));
